...
werden eine Reihen von etablierten Vokabularen wie ICONCLASS, GND und die
...
Ausgewählte kontrollierte Vokabulare werden zentral in den Property Graphen eingespielt. Die konkrete Modellierung und Implementierung ist noch in Arbeit.

Konkret spielen unter Anderem folgende CRM-Bestandteile eine Rolle:

- [E32 Authority Document](https://cidoc-crm.org/html/cidoc_crm_v7.1.3_with_translations.html#E32)
- [P71 lists](https://cidoc-crm.org/html/cidoc_crm_v7.1.3_with_translations.html#P71)
- [E55 Type](https://cidoc-crm.org/html/cidoc_crm_v7.1.3_with_translations.html#E55)
- [P127 has broader term](https://cidoc-crm.org/html/cidoc_crm_v7.1.3_with_translations.html#P127)
...
In RDF entspricht dies ungefähr:

- P71 is die Inverse Relation von `skos:inScheme`
- E32 entspricht `skos:ConceptScheme`
- E55 entspricht `skos:Concept` (allerdings kann jede Klasse auch als Konzept verwendet werden) 
- P127 entspricht `skos:broader`
- P150 ist Spezialfall von `skos:related`
- P137 is inverse von `skos:example`
...
Wenn möglich sollten CRM-Klassen statt Typen verwendet werden.

:::{.callout-note title="Beispiele"}
```pg
gnd :E32_Authority_Document
  uri:
x :E55_Type uri:"https://d-nb.info/gnd/4052692-6"
x -> gnd
```
:::
