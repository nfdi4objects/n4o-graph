...
Das Datenbankschema oder **Datenmodell** eines Knowledge Graphen bestimmt welche Arten von Knoten, Kanten und weiterer Inhalte im Graph enthalten sein dürfen. Das Schemas basiert  auf dem abstrakten Datenmodell [CIDOC-CRM](crm.qmd). Details zu den Schemas finden sich im [Kapitel Datenbankschema](schema.qmd).
