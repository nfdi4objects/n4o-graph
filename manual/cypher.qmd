...
Eine öffentliche Entwicklungsversion des Property Graphen kann mit der Abfragesprache Cypher über die API-URL <{{< meta public >}}> abgefragt werden. Die Cypher-Abfrage wird mit dem Query-Parameter `cypher` übergeben.
